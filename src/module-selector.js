export function showModuleSelector(manifest, container) {
    return new Promise((resolve) => {
      ...
      `;
            ...
            const items = container.querySelectorAll('.module-selector__item');
        ...
        function handleClick(e) {
            const item = e.target.closest('.module-selector__item');
            if (item) {
            ...
            if (e.target.closest('.module-selector__start')) {
                start();
            }
        }
        function cleanup() {
